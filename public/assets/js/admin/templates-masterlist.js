$(document).ready(function () {
    let table = $('#templatesmasterlist').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "/admin/templatesmasterlist/getData",
            "type": "POST",
                ...
                "render": function (data, type, row) {
                    return `
                        <div class="action-buttons">
                            ...
                            <a href="/admin/edit-template/${row.grid_template_id}" title="Edit" class="edit-btn" style="color: #007bff;">
    ...
    $(document).on('click', '.view-btn', function () {
        ...
        $.ajax({
            url: '/admin/templatesmasterlist/getTemplate/' + id,
            method: 'GET',
            dataType: 'json',
    ...
    $(document).on('click', '.toggle-featured', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/admin/templatesmasterlist/toggleFeatured/' + id,
                    method: 'POST',
                    dataType: 'json',
                    success: function (response) {
                        if (response.status === 'success') {
    ...
    $(document).on('click', '.delete-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '/admin/templatesmasterlist/delete/' + id,
                    method: 'DELETE',
                    dataType: 'json',
                    success: function (response) {
                        Swal.close();
