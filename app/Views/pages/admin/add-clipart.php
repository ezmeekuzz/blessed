...
<div class="app-container">
    ...
    <div class="app-main" id="main">
        <div class="container-fluid">
                ...
                <div class="col-md-12 mb-4">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page-title">
                            <h4><i class="fas fa-paint-brush"></i> Add Clip Art</h4>
                        </div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add Clip Art</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <!-- Clip Art Form -->
            <form id="addClipArtForm" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="row">
                    <!-- Main Content Area -->
                    <div class="col-lg-8">
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Enter clip art title" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tags" name="tags" placeholder="e.g., flower, nature, abstract, vintage">
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="localUploadSection" class="source-section">
                                    <div class="form-group">
                                        <label for="clipartImage">Upload Image <span class="text-danger">*</span></label>
                                ...
                                <div id="externalUrlSection" class="source-section" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="image_url" id="imageUrl" class="form-control" placeholder="https://example.com/images/clipart.png">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <button type="submit" class="btn btn-primary btn-block" id="submitBtn">
                                    <i class="fas fa-save"></i> Save Clip Art
                                </button>
...
<script src="<?= base_url(); ?>assets/js/admin/add-clipart.js"></script>