...
<section class="registration-section py-5">
    <div class="container">
        <div class="row g-0 align-items-stretch">
            ...
            <div class="col-lg-6">
                <div class="p-5 h-100 d-flex flex-column" style="background: #F9F7FA; border-radius: 24px 0 0 24px;">
                    ...
                    <form class="registration-form" id="register">
                        <!-- First Name field -->
                        <div class="mb-4">
                            <label for="firstname" class="form-label fw-semibold mb-2" style="color: #3D204E;">First Name</label>
                        ...
                        <!-- Last Name field -->
                        <div class="mb-4">
                            <label for="lastname" class="form-label fw-semibold mb-2" style="color: #3D204E;">Last Name</label>
                        ...
                        <div class="mb-3">
                            <label for="confirmpassword" class="form-label fw-semibold mb-2" style="color: #3D204E;">Confirm Password</label>
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="terms" id="terms" style="border-color: #3D204E;" required>
                                <label class="form-check-label text-secondary" for="terms">
                                    I agree to the <a href="#" style="color: #3D204E; text-decoration: underline;">Terms of Service</a> and <a href="#" style="color: #3D204E; text-decoration: underline;">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="h-100 d-flex flex-column justify-content-center p-5" style="background: linear-gradient(rgba(61, 32, 78, 0.4), rgba(61, 32, 78, 0.4)), url('images/login-bg.png'); background-size: cover; background-position: center; border-radius: 0 24px 24px 0; min-height: 700px;">
                    ...
                    <div class="text-white mt-5">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">✓ Daily devotionals</li>
                            <li class="mb-2">✓ Prayer community</li>
                            <li class="mb-2">✓ Scripture study guides</li>
                            <li class="mb-2">✓ Faith-based resources</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#register').submit(function(event) {
            ...
            // Check if reCAPTCHA is filled (if you have it enabled)
