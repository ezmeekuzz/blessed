$(document).ready(function () {
    let table = $('#blogcategories').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "/admin/blogcategories/getData",
            "type": "POST"
        },
        "columns": [
            { "data": "categoryname" },
                ...
                "render": function (data, type, row) {
                    return `
                        <div class="btn-group" role="group">
                            <a href="#" title="Edit" class="edit-btn mr-2" data-id="${row.blog_category_id}" style="color: #007bff;">
                                <i class="ti ti-pencil" style="font-size: 18px;"></i>
                            </a>
                            <a href="#" title="Delete" class="delete-btn" data-id="${row.blog_category_id}" style="color: red;">
        ...
        "createdRow": function (row, data, dataIndex) {
            $(row).attr('data-id', data.blog_category_id);
        },
    ...
    $('#addCategoryForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '/admin/blogcategories/insert',
            method: 'POST',
            data: {
    ...
    $(document).on('click', '.edit-btn', function () {
        ...
        $.ajax({
            url: '/admin/blogcategories/getCategory/' + id,
            method: 'GET',
            dataType: 'json',
            success: function (response) {
                Swal.close();
                ...
                if (response.status === 'success') {
                    ...
                    $('#editCategoryId').val(response.data.blog_category_id);
    ...
    $('#editCategoryForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '/admin/blogcategories/update/' + categoryId,
            method: 'POST',
            data: {
                categoryname: categoryName,
                status: status
