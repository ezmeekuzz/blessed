...
<div class="app-container">
    ...
    <div class="app-main" id="main">
        <div class="container-fluid">
                ...
                <div class="col-md-12 mb-4">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page-title">
                            <h4><i class="fas fa-sticker-mulu"></i> Edit Sticker</h4>
                        </div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Sticker</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <!-- Sticker Form -->
            <form id="editStickerForm" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <input type="hidden" name="sticker_id" id="stickerId" value="<?= $sticker['sticker_id'] ?>">
                <div class="row">
                    <!-- Main Content Area -->
                    <div class="col-lg-8">
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" value="<?= esc($sticker['title']) ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="3"><?= esc($sticker['description']) ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tags" name="tags" value="<?= esc($sticker['tags']) ?>" placeholder="e.g., vinyl, waterproof, custom, laptop">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <?php 
                                $isExternal = strpos($sticker['image_url'], 'http://') === 0 || strpos($sticker['image_url'], 'https://') === 0;
                                ?>
                                <div class="form-group">
                                    <label class="d-block">Select Image Source <span class="text-danger">*</span></label>
                                    <div class="btn-group w-100" role="group">
                                        <button type="button" class="btn btn-outline-primary source-type-btn <?= !$isExternal ? 'active' : '' ?>" data-source="local">
                                            <i class="fas fa-upload"></i> Upload File
                                        </button>
                                        <button type="button" class="btn btn-outline-primary source-type-btn <?= $isExternal ? 'active' : '' ?>" data-source="external">
                                            <i class="fas fa-link"></i> External URL
                                        </button>
                                    </div>
                                    <input type="hidden" name="source_type" id="sourceType" value="<?= $isExternal ? 'external' : 'local' ?>">
                                </div>
                                ...
                                <div id="localUploadSection" class="source-section" style="<?= $isExternal ? 'display: none;' : '' ?>">
                                    <div class="form-group">
                                        <label for="stickerImage">Upload New Image (Optional)</label>
                                ...
                                <div id="externalUrlSection" class="source-section" style="<?= $isExternal ? '' : 'display: none;' ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="image_url" id="imageUrl" class="form-control" value="<?= $isExternal ? esc($sticker['image_url']) : '' ?>" placeholder="https://example.com/images/sticker.png">
                                        ...
                                        <div id="externalImagePreview" class="mt-3 text-center" style="<?= $isExternal ? '' : 'display: none;' ?>">
                                            <div class="border rounded p-2 bg-light">
                                                <img src="<?= $isExternal ? esc($sticker['image_url']) : '' ?>" class="img-fluid" style="max-height: 150px;" alt="Preview">
                                                <div class="mt-2">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status">
                                        <option value="active" <?= $sticker['is_active'] == 1 ? 'selected' : '' ?>>Active</option>
                                        <option value="inactive" <?= $sticker['is_active'] == 0 ? 'selected' : '' ?>>Inactive</option>
                                    </select>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <button type="submit" class="btn btn-primary btn-block" id="submitBtn">
                                    <i class="fas fa-save"></i> Update Sticker
                                </button>
...
<script src="<?= base_url(); ?>assets/js/admin/edit-sticker.js"></script>