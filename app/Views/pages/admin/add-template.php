                ...
                <div class="col-md-12 m-b-30">
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h4><i class="fas fa-th-large"></i> Add Grid Template</h4>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="grid-preview" id="gridPreview">
                                    <div class="empty-state">
                                        ...
                                        <h5>No Layout Yet</h5>
                                        <p class="text-muted">Select a preset below or click "Add Row" to start</p>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow-sm mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="templateName" class="form-control" placeholder="e.g., 3-Column Grid, Product Gallery" required>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Presets Card - Improved -->
                        <div class="card shadow-sm mb-3">
                            <div class="card-header bg-white">
